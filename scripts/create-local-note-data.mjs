...
const fixtures = [
  {
    username: 'demo',
    idempotencyKey: 'script:note-create:9a908571-e394-4e85-8a50-617e8640dd01',
  ...
  {
    username: 'demo',
    idempotencyKey: 'script:note-create:9a908571-e394-4e85-8a50-617e8640dd02',
  ...
  },
  {
    ...
    idempotencyKey: 'script:note-create:9a908571-e394-4e85-8a50-617e8640dd03',

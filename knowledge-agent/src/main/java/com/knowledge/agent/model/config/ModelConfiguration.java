...
public class ModelConfiguration {
    ...
    ChatModel deepSeekChatModel(ModelProperties properties) {
    ...
    @Bean
    @ConditionalOnProperty(name = "knowledge.agent.model.enabled", havingValue = "true")
    StreamingChatModel deepSeekStreamingChatModel(ModelProperties properties) {
        validateApiKey(properties);
    ...
    private void validateApiKey(ModelProperties properties) {
